...
public class Connection extends Thread {
  ...
  private String identifier;
	 ...
	 */
	public Connection(SocketPlugin pool, String host, int port, String identifier) {
		super();
		setDaemon(true);
				...
				try {
					...
					if (this.isConnected()) {
						...
						if (chunk != null) {
							...
							hook.sendMessage(this.host, this.port, this.identifier, chunk);
						} else {
                            hook.sendMessage(this.host, this.port, this.identifier, null);
                        }
					}
